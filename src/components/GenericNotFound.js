    ...
    return (
      <DocumentTitle title='Page not found'>
        <div className="notfound">
          ...
          <p>
            This <b>{this.props.location.pathname}</b> path was not found on this website.
            Please check the URL for mistakes and try again.
          </p>
          <div className="row">
            <Link to={'/'} className="btn btn-menu">Home</Link>
          </div>
          <a className="firebase-logo" href="//firebase.google.com">
